...
[FastMCP](https://gofastmcp.com/getting-started/welcome) [package](https://pypi.org/project/fastmcp/) `fastmcp 3.0.1`
```python 
...
```
>`show_banner=False`: *tắt banner chạy chế độ im lặng stdout chỉ chứa JSON.*

## **Kiểm thử MCP**
Test nhanh bằng [CLI](/mcp/mcp-test.md) hoặc MCP Inspector